...
// ambil file functions.php      
    ...
    // get id dari url
      $id = $_GET['ede-t'];
        ...
        $ressId = query("SELECT * FROM catatan WHERE id_catatan = '$id'")[0];
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Edit Catatan</a>
      </li>
    </ul>
                ...
                <div class="card card-info">
                  ...
                  <div class="card-body">
                    <form action="" method="post">
                        <input type="hidden" name="edtl-t" value="<?= $ressId['id_catatan']?>">
                        <div class="input-group mb-3">
                          <!-- <div class="input-group-prepend">
                            <span class="input-group-text">Pilih Tanggal</span>
                          </div> -->
                          <input name="tanggal" type="date" class="form-control" value="<?= $ressId['tanggal'] ?>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <!-- <span class="input-group-text">Pilih Jam</span> -->
                          </div>
                          <input name="waktu" type="time" class="form-control" value="<?= $ressId['jam'] ?>" >
                        </div>
                        <div class="input-group mb-3">
                          <!-- <div class="input-group-prepend">
                            <span class="input-group-text">Lokasi</span>
                          </div> -->
                          <input name="lokasi" type="txt" class="form-control" placeholder="Lokasi" value="<?= $ressId['lokasi'] ?>" >
                        </div>
                        <div class="input-group mb-3">
                          <!-- <div class="input-group-prepend">
                            <span class="input-group-text">Suhu Tubuh</span>
                          </div> -->
                          <input name="suhu" type="text" class="form-control" placeholder="Suhu Tubuh" value="<?= $ressId['suhu'] ?>" >
                        </div>    
                        <!-- /input-group -->
                      </div>
                      <!-- /.card-body -->
                      ...
                      <div class=" d-flex position-absolute" style="right:0; margin-right:20px;">
                        <div class=" m-2">
                            <button name="ubah" class=".btn-lg dark bg-dark p-absolute" style="padding: 5px 50px; border-radius:5px; border:none; ">ubah</button>
                        </div>
                     </div>
                            <!-- /button submit -->
                   </form>
